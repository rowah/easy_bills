...
#         />
#       </div>
#       <%!-- mx-auto my-auto max-w-sm sm:mt-10 --%>
#       <div class="my-auto max-w-sm mx-auto">
#         <%!-- <ul class="relative z-10 flex items-center gap-4 px-4 sm:px-6 lg:px-8 justify-end"> --%>
#         <%= if @current_user do %>
#           <div class="space-y-4">
#             <div class="flex md:mt-32 lg:mt-0">
...
#               role="button"
#               class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-full border-gray-300 flex items-center w-full mt-10"
#             >
#               <svg
#                 width="19"
#                 height="20"
...
#               <p class="text-xs px-14">
#                 By creating an account, you agree to EasyBills Company's
