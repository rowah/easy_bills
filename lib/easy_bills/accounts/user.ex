defmodule EasyBills.Accounts.User do
  @moduledoc false
  ...
  defp validate_password(changeset, opts) do
    ...
    |> validate_length(:password, min: 8, max: 72, messsage: "8+ characters")
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, EasyBills.Repo)
  ...
  """
  def valid_password?(%EasyBills.Accounts.User{hashed_password: hashed_password}, password)
